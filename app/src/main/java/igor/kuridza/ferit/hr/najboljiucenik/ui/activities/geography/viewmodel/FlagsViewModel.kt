package igor.kuridza.ferit.hr.najboljiucenik.ui.activities.geography.viewmodel
...
class FlagsViewModel @ViewModelInject constructor(
    ...
    private val _questions = MutableLiveData<List<FlagQuestion>>()
    ...
    private val questions: LiveData<List<FlagQuestion>> = _questions
    ...
    private fun getQuestions(): List<FlagQuestion>{
        return flagQuestionRepository.get10FlagQuestions()
    }
